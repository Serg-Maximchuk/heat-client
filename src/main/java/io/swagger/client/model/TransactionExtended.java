...
/**
 * Transaction Extended class
 */
@Schema(description = "Transaction Extended class")
...
public class TransactionExtended {
  ...
  public TransactionExtended type(Integer type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public TransactionExtended subtype(Integer subtype) {
  ...
  **/
  ...
  public TransactionExtended timestamp(Integer timestamp) {
  ...
  **/
  ...
  public TransactionExtended deadline(Integer deadline) {
  ...
  **/
  ...
  public TransactionExtended senderPublicKey(String senderPublicKey) {
  ...
  **/
  ...
  public TransactionExtended recipient(String recipient) {
  ...
  **/
  ...
  public TransactionExtended recipientPublicKey(String recipientPublicKey) {
  ...
  **/
  ...
  public TransactionExtended amount(String amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public TransactionExtended fee(String fee) {
    this.fee = fee;
    return this;
  }
  ...
  **/
  ...
  public TransactionExtended signature(String signature) {
  ...
  **/
  ...
  public TransactionExtended signatureHash(String signatureHash) {
  ...
  **/
  ...
  public TransactionExtended fullHash(String fullHash) {
  ...
  **/
  ...
  public TransactionExtended transaction(String transaction) {
  ...
  **/
  ...
  public TransactionExtended attachment(Map<String, Object> attachment) {
    this.attachment = attachment;
    return this;
  }

  public TransactionExtended putAttachmentItem(String key, Object attachmentItem) {
  ...
  **/
  ...
  public TransactionExtended sender(String sender) {
    this.sender = sender;
    return this;
  }
  ...
  **/
  ...
  public TransactionExtended height(Integer height) {
    this.height = height;
    return this;
  }
  ...
  **/
  ...
  public TransactionExtended version(Integer version) {
  ...
  **/
  ...
  public TransactionExtended ecBlockId(String ecBlockId) {
  ...
  **/
  ...
  public TransactionExtended ecBlockHeight(Integer ecBlockHeight) {
  ...
  **/
  ...
  public TransactionExtended messageBytes(String messageBytes) {
  ...
  **/
  ...
  public TransactionExtended messageIsText(Boolean messageIsText) {
  ...
  **/
  ...
  public TransactionExtended messageIsEncrypted(Boolean messageIsEncrypted) {
  ...
  **/
  ...
  public TransactionExtended messageIsEncryptedToSelf(Boolean messageIsEncryptedToSelf) {
  ...
  **/
  ...
  public TransactionExtended senderPublicName(String senderPublicName) {
  ...
  **/
  @Schema(required = true, description = "Sender public name")
  ...
  public TransactionExtended recipientPublicName(String recipientPublicName) {
  ...
  **/
  @Schema(required = true, description = "Recipient public name")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransactionExtended transactionExtended = (TransactionExtended) o;
    return Objects.equals(this.type, transactionExtended.type) &&
        Objects.equals(this.subtype, transactionExtended.subtype) &&
        Objects.equals(this.timestamp, transactionExtended.timestamp) &&
        Objects.equals(this.deadline, transactionExtended.deadline) &&
        Objects.equals(this.senderPublicKey, transactionExtended.senderPublicKey) &&
        Objects.equals(this.recipient, transactionExtended.recipient) &&
        Objects.equals(this.recipientPublicKey, transactionExtended.recipientPublicKey) &&
        Objects.equals(this.amount, transactionExtended.amount) &&
        Objects.equals(this.fee, transactionExtended.fee) &&
        Objects.equals(this.signature, transactionExtended.signature) &&
        Objects.equals(this.signatureHash, transactionExtended.signatureHash) &&
        Objects.equals(this.fullHash, transactionExtended.fullHash) &&
        Objects.equals(this.transaction, transactionExtended.transaction) &&
        Objects.equals(this.attachment, transactionExtended.attachment) &&
        Objects.equals(this.sender, transactionExtended.sender) &&
        Objects.equals(this.height, transactionExtended.height) &&
        Objects.equals(this.version, transactionExtended.version) &&
        Objects.equals(this.ecBlockId, transactionExtended.ecBlockId) &&
        Objects.equals(this.ecBlockHeight, transactionExtended.ecBlockHeight) &&
        Objects.equals(this.messageBytes, transactionExtended.messageBytes) &&
        Objects.equals(this.messageIsText, transactionExtended.messageIsText) &&
        Objects.equals(this.messageIsEncrypted, transactionExtended.messageIsEncrypted) &&
        Objects.equals(this.messageIsEncryptedToSelf, transactionExtended.messageIsEncryptedToSelf) &&
        Objects.equals(this.senderPublicName, transactionExtended.senderPublicName) &&
        Objects.equals(this.recipientPublicName, transactionExtended.recipientPublicName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, subtype, timestamp, deadline, senderPublicKey, recipient, recipientPublicKey, amount, fee, signature, signatureHash, fullHash, transaction, attachment, sender, height, version, ecBlockId, ecBlockHeight, messageBytes, messageIsText, messageIsEncrypted, messageIsEncryptedToSelf, senderPublicName, recipientPublicName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionExtended {\n");
